  ...
  <body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="{{ route('user.db.registration')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input name="name" type="text" required placeholder="Enter your name" class="form-control">
